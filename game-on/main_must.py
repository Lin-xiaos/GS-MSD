...
import config, model_mu, dataset, engine_st, utils
...
if __name__ == '__main__':
    ...
    for epoch in range(config.epochs):
        ...
        train_loss, train_report, val_loss, val_report, train_sar_f1, sar_f1 = engine_st.train_func_epoch(
        ...
        test_loss, test_report, test_f1 = engine_st.eval_func(gnn_model, dataloader_test, device)
